...
import PropertyFilters from "../PropertyPage/PropertyFilters";
import ShareAdsModal from "../PropertyPage/ShareAdsModal";

// filters,setFilters,properties,
const PropertiesAdminPage = ({cities,filters, setFilters, toggleSelectAd, selectedAds,properties,handleAdChange,fetchPropertiesWithFilter,mysubscriptionPlan}:any) => {
  // const [filters, setFilters] = useState({
  //   property_type: "",
  //   city: "",
  //   reason: "",
